...
class LibroController extends Controller
{
    ...
    public function create()
    {
        ...
        #METODO pluck DEVUELVE DATOS EN ORDEN nombre y id
        #AL RETORNAR SE DEBE AGREGAR VARIABLE $categorias PARA PODER USAR LOS VALORES EN VISTA CREAR
    ...
    public function edit($id)
    {
        ...
        #METODO pluck DEVUELVE DATOS EN ORDEN nombre y id
        #AL RETORNAR SE DEBE AGREGAR VARIABLE $categorias PARA PODER USAR LOS VALORES EN VISTA EDITAR
        $categorias = Categoria::pluck('nombre','id');
